...
// 1.使用数组保存信息
let infoArray : [Any] = ["mr", 18, 1.88]
let arrayName = infoArray[0] as! String
print(arrayName.characters.count)


// 2.使用字典保存信息
let infoDict : [String : Any] = ["name" : "mr", "age" : 18, "height" : 1.88]
...
// 3.2.写法二:
let infoTuple1 = (name : "mr",age : 18, height : 1.88)
infoTuple1.age
infoTuple1.name
infoTuple1.height
...
// 3.3.写法三:
let (name, age, height) = ("mr", 18, 1.88)
name
age
height
